<footer class="footer">
    <div class="container-fluid">
        ...
        <div class="copyright">
            ...
            <a href="https://github.com/Gossteer" target="_blank">{{ __('Gossteer') }}</a> &amp;
            <a href="https://github.com/StefanBokarev" target="_blank">{{ __('StefanBokarev') }}</a> {{ __('for a better web') }}.
        </div>
    </div>
</footer>
